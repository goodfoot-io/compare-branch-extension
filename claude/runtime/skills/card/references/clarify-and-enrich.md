<!-- @goodfoot/agent-skills source: skills-src/runtime/card/references/clarify-and-enrich.md.eta sha256:f74717e6dfdce79f779f685c9258d87694bfc720ba8fbea4559ba3f1054efd22 -->
...
Load the `runtime:card` skill to re-evaluate the card's state and route to the appropriate next reference. On this second pass, skip the NOT DOR_MET route — enrichment has already been attempted this session.

```xml
<invoke name="Skill">
<parameter name="skill">runtime:card</parameter>
</invoke>
```
