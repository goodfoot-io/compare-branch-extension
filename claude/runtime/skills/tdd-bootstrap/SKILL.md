...
---
<!-- @cards.management/agent-skills source: public/skills-src/runtime/tdd-bootstrap/SKILL.md.eta sha256:7dc59cfb8ef54bd56d8eb68ae582216ffe359d0057425bf695242b088b118606 -->
...
- Lint and typecheck per the project's CLAUDE.md validation conventions. Re-run the single check just unskipped until it passes; once green, run the file's unskipped checks together before moving to the next
