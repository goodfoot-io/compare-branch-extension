...
The publisher materializes the writing guides, `commanders-intent.md`, and `deep-card.md` as regular files under `public/codex/runtime/skills/interview/references/`:
