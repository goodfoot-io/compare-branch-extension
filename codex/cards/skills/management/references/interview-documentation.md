...
Load `$markdown`, `./commanders-intent.md`, and the writing guide `./documentation.md`. The writing guide defines the CARD.md structure this interview is driving toward.
