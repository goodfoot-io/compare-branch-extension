...
Load `$markdown`, `./commanders-intent.md`, and the writing guide `./maintenance.md`. The writing guide defines the CARD.md structure this interview is driving toward.
