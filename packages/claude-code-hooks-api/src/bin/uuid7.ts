/**
 * Generates UUIDv7 identifiers for card content (comments, etc.).
 *
 * Duplicates the implementation from `claude-code-hooks-runtime` so that the
 * cards API plugin ships its own copy without a cross-plugin dependency.
 *
 * @summary UUIDv7 generator for cards API plugin
 */
