/**
 * Real-process coverage for bounded, owned-tree Claude termination.
 *
 * @summary Claude termination controller behavior
 * @module
 */
...
async function controller(
  ...
  const { createClaudeTerminationController } = await import('../src/lib/claude-termination.js');
  return createClaudeTerminationController(child, options);
}
...
describe('Claude termination controller', () => {
