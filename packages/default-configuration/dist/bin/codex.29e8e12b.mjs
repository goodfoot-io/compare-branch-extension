...
function buildCodexSkillConfigOverride(skillPath) {
  return `skills.config=[{path=${JSON.stringify(skillPath)},enabled=true}]`;
}
function buildCodexArgs(prompt, workspacePath, cardRepoPath, skillPath) {
  return [
...
async function spawnCodexSession(input, context, options) {
  ...
  await fs3.access(codexSkillPath);
