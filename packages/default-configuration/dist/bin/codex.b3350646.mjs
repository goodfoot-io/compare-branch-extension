...
async function cleanupMergedBranches(input, client, logger2, sessionId) {
  ...
  for (const branch of branches) {
    ...
    if (branch.parentBranch === branch.name) {
      logger2.warn("Skipping branch with self-referential parentBranch (corrupt state)", {
        branch: branch.name
      });
      continue;
    }
...
function resolveCodexSkillPath(marketplacePath) {
  return path3.join(marketplacePath, ".agents", "skills", "cards-runtime", "SKILL.md");
}
