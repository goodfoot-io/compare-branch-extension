/**
 * Typed Zustand selector hook for the opencode-session stream store.
 *
 ...
 * This re-export mirrors the codex-session renderer's hook exactly; the
 * SDK stream store is shared across renderers through the module system.
 *
 * @summary Typed Zustand selector hook for streamStore
 * @module streams/opencode-session/www/hooks/useStreamStore
 */
