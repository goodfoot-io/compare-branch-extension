...
describe('Stop Hook', () => {
  ...
  describe('inside an action subprocess', () => {
    ...
    it('returns undefined when no HEAD SHA stored for session', async () => {
    ...
    it('returns undefined when no commits since HEAD SHA', async () => {
    ...
    it('returns undefined when all commits are attributed to session', async () => {
      mockReadSessionHeadSha.mockReturnValue(START_SHA);
    ...
    it('returns undefined (fail open) when git log fails', async () => {
      mockReadSessionHeadSha.mockReturnValue(START_SHA);
    ...
    it('returns undefined (fail open) when CSV read fails', async () => {
      mockReadSessionHeadSha.mockReturnValue(START_SHA);
  ...
  describe('outside an action subprocess', () => {
    it('returns undefined when action env vars are missing', async () => {
