 ...
 */
export type HookEventName = 'StartCard' | 'EndCard' | 'StartInterview' | 'EndInterview' | 'TypedFileCreated' | 'TypedFileUpdated' | 'TypedFileDeleted';
/**
 ...
 * ```
 */
export declare const HOOK_EVENT_NAMES: readonly ["StartCard", "EndCard", "StartInterview", "EndInterview", "TypedFileCreated", "TypedFileUpdated", "TypedFileDeleted"];
/**
