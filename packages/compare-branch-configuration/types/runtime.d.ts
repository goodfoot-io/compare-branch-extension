...
import type { EndCardInput, EndInterviewInput, StartCardInput, StartInterviewInput } from './types.js';
/**
 * Union type of all possible hook functions.
 * This allows execute() to accept any hook function type.
 */
type AnyHookFunction = HookFunction<StartCardInput> | HookFunction<EndCardInput> | HookFunction<StartInterviewInput> | HookFunction<EndInterviewInput>;
/**
