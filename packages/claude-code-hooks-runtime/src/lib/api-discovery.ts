 ...
 * constructs a {@link CardsClient} for use by hook entrypoints.
 *
 ...
 * required fields absent). The hook layer uses this to degrade gracefully.
 *
 ...
 */
export async function createCardsClient(logger?: Logger): Promise<CardsClient | null> {
