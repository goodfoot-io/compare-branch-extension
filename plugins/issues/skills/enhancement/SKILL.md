...
| Implementation Approach | Describe the path forward | "How could we get there?" |
...
## Section 2: Current Functionality
...
## Section 3: Desired Functionality
...
Keep description separate from prescription. Current Functionality describes what is; Desired Functionality describes what should be; Implementation Approach describes how to bridge them. Mixing these creates confusion.
