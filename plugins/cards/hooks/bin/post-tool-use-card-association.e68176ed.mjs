  ...
  try {
    ...
    for (const sha of pendingCommits) {
      ...
      try {
        ...
        logger2.debug("Failed to flush pending commit", { sha, error: String(error) });
      }
    }
    return postToolUseOutput({
