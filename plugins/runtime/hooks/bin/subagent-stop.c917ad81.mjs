...
if (!process.env['CLAUDE_CODE_HOOKS_LOG_FILE']) {
  process.env['CLAUDE_CODE_HOOKS_LOG_FILE'] = "/workspace/.worktrees/cards/main-89/1/.cards/logs/claude-code-cards-runtime-hooks.log";
}
