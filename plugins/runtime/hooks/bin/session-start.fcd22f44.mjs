...
function writeSessionHeadSha(sessionId, sha) {
  mkdirSync(getCardRepoCommitsDir(), { recursive: true, mode: 448 });
  writeFileSync(getSessionHeadShaPath(sessionId), sha, { mode: 384 });
}
