...
Write `CARD.md.meta.json` with a `title` (4–10 word document title naming the unknown or question) and `summary` (100–300 characters: what needs to be learned, why the answer is not yet known, and what decision it unblocks).
