...
When an item reveals a gap, return to §2.1 for the affected area — a gap in the plan likely reflects a gap in the research. Update PLAN.md with the deeper findings, commit, then re-verify from the affected item.
