...
- **Behavioral or cross-file**: Any new logic, new API boundary, multi-file change, or async/error-path modification. Load the `runtime:card-implementation-evaluation` skill and follow its instructions.
