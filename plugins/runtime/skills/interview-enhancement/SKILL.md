...
Write `CARD.md.meta.json` with a `title` (4–10 word document title naming the capability gap or need) and `summary` (100–300 characters: the gap between current and desired state that motivates this work).
