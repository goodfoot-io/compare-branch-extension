...
var stop_default = stopHook({}, async (input, { logger: logger2 }) => {
  ...
  try {
    ...
    const baseUrl = apiInfo ? `http://${apiInfo.host}:${apiInfo.port}` : await discoverApiUrl(logger2);
