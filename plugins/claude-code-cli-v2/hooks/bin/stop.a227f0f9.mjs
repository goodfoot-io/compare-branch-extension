...
async function checkRemoteUpdates(issueId, baseUrl, logger2) {
  try {
...
var stop_default = stopHook({}, async (input, { logger: logger2 }) => {
  ...
  try {
    ...
    const hasUpdates = await checkRemoteUpdates(issueId, baseUrl, logger2);
    if (hasUpdates) {
      return stopOutput({
        decision: "block",
        reason: "Issue has remote updates",
        systemMessage: "Issue has updates. Please sync before stopping."
      });
    }
