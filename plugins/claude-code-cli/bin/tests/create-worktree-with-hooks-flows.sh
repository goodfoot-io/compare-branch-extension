...
# Integration test suite for create-worktree-with-hooks and remove-worktree-with-hooks
...
echo "Integration Test Suite: create-worktree-with-hooks + remove-worktree-with-hooks"
