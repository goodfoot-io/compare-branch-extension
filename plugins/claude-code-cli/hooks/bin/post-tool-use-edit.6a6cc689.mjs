...
// src/claude-code-cli/post-tool-use-edit.ts
...
// src/claude-code-cli/post-tool-use-edit-entry.ts
process.env["CLAUDE_CODE_HOOKS_CLI_LOG_FILE"] = "/tmp/hooks-cli.log";
