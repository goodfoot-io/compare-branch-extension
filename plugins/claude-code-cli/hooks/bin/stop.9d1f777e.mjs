...
var stop_default = stopHook({}, (input, { logger: logger2 }) => {
  logger2.info("Stop hook triggered", { input });
  return stopOutput({
    decision: "approve",
