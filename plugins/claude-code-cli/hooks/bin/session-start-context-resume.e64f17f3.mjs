...
// src/session-start-context-resume.ts
var session_start_context_resume_default = sessionStartHook({ matcher: "resume" }, async (input, { logger: logger2 }) => {
